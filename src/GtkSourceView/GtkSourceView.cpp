...
Php::Value GtkSourceView_::get_show_line_numbers() {
  bool ret = gtk_source_view_get_show_line_numbers(GTK_SOURCE_VIEW(instance)) != 0;
...
Php::Value GtkSourceView_::get_show_right_margin() {
  bool ret = gtk_source_view_get_show_right_margin(GTK_SOURCE_VIEW(instance)) != 0;
...
Php::Value GtkSourceView_::get_highlight_current_line() {
  bool ret = gtk_source_view_get_highlight_current_line(GTK_SOURCE_VIEW(instance)) != 0;
...
Php::Value GtkSourceView_::get_insert_spaces_instead_of_tabs() {
  bool ret = gtk_source_view_get_insert_spaces_instead_of_tabs(GTK_SOURCE_VIEW(instance)) != 0;
...
Php::Value GtkSourceView_::get_smart_backspace() {
  bool ret = gtk_source_view_get_smart_backspace(GTK_SOURCE_VIEW(instance)) != 0;
...
Php::Value GtkSourceView_::get_show_line_marks() {
  bool ret = gtk_source_view_get_show_line_marks(GTK_SOURCE_VIEW(instance)) != 0;

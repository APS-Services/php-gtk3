...
Php::Value GtkPrintSettings_::get_bool(Php::Parameters &parameters) {
  ...
  bool ret = gtk_print_settings_get_bool(GTK_PRINT_SETTINGS(instance), key) != 0;
...
Php::Value GtkPrintSettings_::get_use_color() {
  bool ret = gtk_print_settings_get_use_color(GTK_PRINT_SETTINGS(instance)) != 0;
...
Php::Value GtkPrintSettings_::load_file(Php::Parameters &parameters) {
  ...
  GError *error = nullptr;
  bool ret = gtk_print_settings_load_file(GTK_PRINT_SETTINGS(instance), file_name, &error) != 0;
...
Php::Value GtkPrintSettings_::to_file(Php::Parameters &parameters) {
  ...
  GError *error = nullptr;
  bool ret = gtk_print_settings_to_file(GTK_PRINT_SETTINGS(instance), file_name, &error) != 0;

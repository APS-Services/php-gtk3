...
Php::Value GtkTextView_::move_mark_onscreen(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_view_move_mark_onscreen(GTK_TEXT_VIEW(instance), mark) != 0;
...
Php::Value GtkTextView_::get_iter_at_position(Php::Parameters &parameters) {
  ...
  bool ret =
      gtk_text_view_get_iter_at_position(GTK_TEXT_VIEW(instance), &target_iter, nullptr, x, y) != 0;
  if (!ret) {
    return ret;
  }
...
Php::Value GtkTextView_::forward_display_line(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_view_forward_display_line(GTK_TEXT_VIEW(instance), &type) != 0;
...
Php::Value GtkTextView_::backward_display_line(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_view_backward_display_line(GTK_TEXT_VIEW(instance), &type) != 0;
...
Php::Value GtkTextView_::forward_display_line_end(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_view_forward_display_line_end(GTK_TEXT_VIEW(instance), &type) != 0;
...
Php::Value GtkTextView_::backward_display_line_start(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_view_backward_display_line_start(GTK_TEXT_VIEW(instance), &type) != 0;
...
Php::Value GtkTextView_::starts_display_line(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_view_starts_display_line(GTK_TEXT_VIEW(instance), &type) != 0;
...
Php::Value GtkTextView_::move_visually(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_view_move_visually(GTK_TEXT_VIEW(instance), &type, count) != 0;

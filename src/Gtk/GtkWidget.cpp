...
void GtkWidget_::add_accelerator(Php::Parameters &parameters) {
  if (parameters.size() < 5) {
    throw Php::Exception(
        "Expected 5 parameters: accel_signal, accel_group, "
...
Php::Value GtkWidget_::can_activate_accel(Php::Parameters &parameters) {
  ...
  bool ret = gtk_widget_can_activate_accel(GTK_WIDGET(instance), signal_id) != 0;
...
Php::Value GtkWidget_::mnemonic_activate(Php::Parameters &parameters) {
  ...
  bool ret = gtk_widget_mnemonic_activate(GTK_WIDGET(instance), group_cycling) != 0;

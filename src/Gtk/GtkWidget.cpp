...
{
// // 	std::string s_accel_signal = std::string(parameters[0]);
...
// // 	std::string s_path = std::string(parameters[1]);
// 	gchar *path = (gchar *)s_path.c_str();

// // 	std::string s_path_reversed = std::string(parameters[2]);
...
void GtkWidget_::override_background_color(Php::Parameters &parameters)
{
	...
	if(parameters[1].isString()) {
		std::string s_color = std::string(parameters[1]);
...
{
	std::string s_font_desc = std::string(parameters[0]);
...
// // 	std::string s_detail = std::string(parameters[2]);
...
{
// // 	std::string s_property_name = std::string(parameters[0]);
...
{
	std::string s_child_property = std::string(parameters[0]);
...
{
// // 	std::string s_prefix = std::string(parameters[0]);
...
{
	// std::string s_resource_name = std::string(parameters[0]);
...
{
// // 	std::string s_callback_name = std::string(parameters[0]);

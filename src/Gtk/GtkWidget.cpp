...
void GtkWidget_::add_accelerator(Php::Parameters &parameters) {
  ...
  // 		GtkAccelFlags_ *phpgtk_accel_flags = (GtkAccelFlags_
  // *)object_accel_flags.implementation(); 		accel_flags =
  // GTK_WIDGET(phpgtk_accel_flags->get_instance());
  // 	}

  // 	gtk_widget_add_accelerator (GTK_WIDGET(instance), accel_signal, accel_group, accel_key,

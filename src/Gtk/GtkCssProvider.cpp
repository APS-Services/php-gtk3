...
Php::Value GtkCssProvider_::load_from_data(Php::Parameters &parameters) {
  ...
  bool ret = gtk_css_provider_load_from_data(GTK_CSS_PROVIDER(instance), data, length, &error) != 0;
...
Php::Value GtkCssProvider_::load_from_file(Php::Parameters &parameters) {
  ...
  bool ret = gtk_css_provider_load_from_file(GTK_CSS_PROVIDER(instance), file, &error) != 0;
...
Php::Value GtkCssProvider_::load_from_path(Php::Parameters &parameters) {
  ...
  bool ret = gtk_css_provider_load_from_path(GTK_CSS_PROVIDER(instance), path, &error) != 0;

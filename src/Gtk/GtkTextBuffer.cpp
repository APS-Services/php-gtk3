...
Php::Value GtkTextBuffer_::delete_interactive(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_buffer_delete_interactive(GTK_TEXT_BUFFER(instance), &start, &end,
                                                default_editable) != 0;
...
Php::Value GtkTextBuffer_::backspace(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_buffer_backspace(GTK_TEXT_BUFFER(instance), &iter, interactive,
                                       default_editable) != 0;
...
Php::Value GtkTextBuffer_::delete_selection(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_buffer_delete_selection(GTK_TEXT_BUFFER(instance), interactive,
                                              default_editable) != 0;
...
Php::Value GtkTextBuffer_::get_selection_bounds(Php::Parameters &parameters) {
  ...
  bool ret = gtk_text_buffer_get_selection_bounds(GTK_TEXT_BUFFER(instance), &start, &end) != 0;
  if (!ret) {
    return ret;
  }

...
{
	std::string s_version = parameters[0].stringValue();
...
{
	std::string s_copyright = parameters[0].stringValue();
...
{
	std::string s_comments = parameters[0].stringValue();
...
{
	std::string s_license = parameters[0].stringValue();
...
{
	std::string s_website = parameters[0].stringValue();
...
{
	std::string s_website_label = parameters[0].stringValue();
...
{
	std::string s_authors = parameters[0].stringValue();
...
{
	std::string s_artists = parameters[0].stringValue();
...
{
	std::string s_documenters = parameters[0].stringValue();
...
{
	std::string s_translator_credits = parameters[0].stringValue();
...
{
	std::string s_section_name = parameters[0].stringValue();
	gchar *section_name = (gchar *)s_section_name.c_str();

	std::string s_people = parameters[1].stringValue();

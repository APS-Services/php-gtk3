...
Php::Value GtkEntryCompletion_::get_inline_completion() {
  bool ret = gtk_entry_completion_get_inline_completion(GTK_ENTRY_COMPLETION(instance)) != 0;
...
Php::Value GtkEntryCompletion_::get_inline_selection() {
  bool ret = gtk_entry_completion_get_inline_selection(GTK_ENTRY_COMPLETION(instance)) != 0;
...
Php::Value GtkEntryCompletion_::get_popup_completion() {
  bool ret = gtk_entry_completion_get_popup_completion(GTK_ENTRY_COMPLETION(instance)) != 0;
...
Php::Value GtkEntryCompletion_::get_popup_set_width() {
  bool ret = gtk_entry_completion_get_popup_set_width(GTK_ENTRY_COMPLETION(instance)) != 0;
...
Php::Value GtkEntryCompletion_::get_popup_single_match() {
  bool ret = gtk_entry_completion_get_popup_single_match(GTK_ENTRY_COMPLETION(instance)) != 0;

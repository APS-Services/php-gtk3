...
{
	std::string s_filename = std::string(parameters[0]);
...
{
	std::string s_string = std::string(parameters[0]);
...
void GtkBuilder_::add_callback_symbol(Php::Parameters &parameters)
{
	...
	// std::string s_add_callback_symbol = std::string(parameters[1]);
...
{
	std::string s_buffer = std::string(parameters[0]);
...
Php::Value GtkBuilder_::extend_with_template(Php::Parameters &parameters)
{
	...
	// std::string s_buffer = std::string(parameters[2]);
	// gchar *buffer = (gchar *)s_buffer.c_str();
...
{
	// std::string s_domain = std::string(parameters[0]);
...
{
	std::string s_type_name = std::string(parameters[0]);

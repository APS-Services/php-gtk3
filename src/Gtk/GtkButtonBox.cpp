...
Php::Value GtkButtonBox_::get_child_secondary(Php::Parameters &parameters) {
  ...
  bool ret = gtk_button_box_get_child_secondary(GTK_BUTTON_BOX(instance), child) != 0;
...
Php::Value GtkButtonBox_::get_child_non_homogeneous(Php::Parameters &parameters) {
  ...
  bool ret = gtk_button_box_get_child_non_homogeneous(GTK_BUTTON_BOX(instance), child) != 0;

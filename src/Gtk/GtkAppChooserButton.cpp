...
Php::Value GtkAppChooserButton_::get_show_default_item() {
  bool ret = gtk_app_chooser_button_get_show_default_item(GTK_APP_CHOOSER_BUTTON(instance)) != 0;
...
Php::Value GtkAppChooserButton_::get_show_dialog_item() {
  bool ret = gtk_app_chooser_button_get_show_dialog_item(GTK_APP_CHOOSER_BUTTON(instance)) != 0;

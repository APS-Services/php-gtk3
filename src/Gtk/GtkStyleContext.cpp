...
void GtkStyleContext_::get(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkStyleContext_::get not implemented - variadic "
...
void GtkStyleContext_::get_property(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkStyleContext_::get_property not implemented - "
...
Php::Value GtkStyleContext_::get_frame_clock() {
  throw Php::Exception(
      "GtkStyleContext_::get_frame_clock not implemented - "
...
void GtkStyleContext_::get_style(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkStyleContext_::get_style not implemented - variadic "
      "function not supported");
}

void GtkStyleContext_::get_style_property(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkStyleContext_::get_style_property not implemented - "
      "GValue handling not yet available");
}

void GtkStyleContext_::get_style_valist(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkStyleContext_::get_style_valist not implemented - "
...
Php::Value GtkStyleContext_::get_section(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkStyleContext_::get_section not implemented - "
...
Php::Value GtkStyleContext_::get_color(Php::Parameters &parameters) {
  ...
  if (parameters.empty()) {
    throw Php::Exception(
        "GtkStyleContext_::get_color: At least one parameter "
        "(state) is required");
  }
  ...
  if (parameters.size() > 1) {
    ...
    if (!object_color.isObject() || !object_color.instanceOf("GdkRGBA")) {
      throw Php::Exception(
          "GtkStyleContext_::get_color: Second parameter must "
...
Php::Value GtkStyleContext_::get_background_color(Php::Parameters &parameters) {
  ...
  if (parameters.empty()) {
    throw Php::Exception(
        "GtkStyleContext_::get_background_color: At least one "
        "parameter (state) is required");
  }
  if (!parameters[0].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::get_background_color: First "
  ...
  if (parameters.size() > 1) {
    ...
    if (!object_color.isObject() || !object_color.instanceOf("GdkRGBA")) {
      throw Php::Exception(
          "GtkStyleContext_::get_background_color: Second "
...
Php::Value GtkStyleContext_::get_border_color(Php::Parameters &parameters) {
  ...
  if (parameters.empty()) {
    throw Php::Exception(
        "GtkStyleContext_::get_border_color: At least one "
        "parameter (state) is required");
  }
  if (!parameters[0].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::get_border_color: First parameter "
  ...
  if (parameters.size() > 1) {
    ...
    if (!object_color.isObject() || !object_color.instanceOf("GdkRGBA")) {
      throw Php::Exception(
          "GtkStyleContext_::get_border_color: Second "
          "parameter must be a GdkRGBA instance");
    }
    GdkRGBA_ *phpgtk_color = (GdkRGBA_ *)object_color.implementation();
    phpgtk_color->set_instance(color);
...
Php::Value GtkStyleContext_::state_is_running(Php::Parameters &parameters) {
  ...
  if (parameters.empty()) {
    throw Php::Exception(
        "GtkStyleContext_::state_is_running: At least one "
        "parameter (state) is required");
  }
  if (!parameters[0].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::state_is_running: First parameter "
        "(state) must be numeric");
  }
  ...
  if (parameters.size() > 1) {
    if (!parameters[1].isNumeric()) {
      throw Php::Exception(
          "GtkStyleContext_::state_is_running: Second "
...
Php::Value GtkStyleContext_::lookup_color(Php::Parameters &parameters) {
  ...
  if (!parameters[0].isString()) {
    throw Php::Exception(
        "GtkStyleContext_::lookup_color: First parameter "
...
Php::Value GtkStyleContext_::lookup_icon_set(Php::Parameters &parameters) {
  ...
  if (!parameters[0].isString()) {
    throw Php::Exception(
        "GtkStyleContext_::lookup_icon_set: First parameter "
  ...
  throw Php::Exception(
      "GtkStyleContext_::lookup_icon_set(): GtkIconSet "
...
void GtkStyleContext_::notify_state_change(Php::Parameters &parameters) {
  ...
  if (!parameters.empty() && !parameters[0].isNull()) {
    ...
    if (!object_window.isObject() || !object_window.instanceOf("GdkWindow")) {
      throw Php::Exception(
          "GtkStyleContext_::notify_state_change(): first "
  ...
  if (parameters.size() > 1 && !parameters[1].isNull()) {
    if (!parameters[1].isNumeric()) {
      throw Php::Exception(
          "GtkStyleContext_::notify_state_change(): second "
...
void GtkStyleContext_::scroll_animations(Php::Parameters &parameters) {
  ...
  if (!parameters.empty() && !parameters[0].isNull()) {
    ...
    if (!object_window.isObject() || !object_window.instanceOf("GdkWindow")) {
      throw Php::Exception(
          "GtkStyleContext_::scroll_animations first "
  ...
  if (parameters.size() > 1 && !parameters[1].isNull()) {
    if (!parameters[1].isNumeric()) {
      throw Php::Exception(
          "GtkStyleContext_::scroll_animations second "
  ...
  if (parameters.size() > 2 && !parameters[2].isNull()) {
    if (!parameters[2].isNumeric()) {
      throw Php::Exception(
          "GtkStyleContext_::scroll_animations third "
...
void GtkStyleContext_::remove_provider_for_screen(Php::Parameters &parameters) {
  ...
  if (provider == nullptr) {
    throw Php::Exception(
        "GtkStyleContext::remove_provider_for_screen requires "
  ...
  if (screen == nullptr) {
    throw Php::Exception(
        "GtkStyleContext::remove_provider_for_screen: no "
...
void GtkStyleContext_::set_background(Php::Parameters &parameters) {
  ...
  if (!parameters.empty() && !parameters[0].isNull()) {
    ...
    if (!object_window.instanceOf("GdkWindow")) {
      throw Php::Exception(
          "GtkStyleContext::set_background expects parameter "
    ...
    if (phpgtk_window == nullptr) {
      throw Php::Exception(
          "GtkStyleContext::set_background received an "
...
void GtkStyleContext_::set_direction(Php::Parameters &parameters) {
  if (parameters.empty()) {
    throw Php::Exception(
        "GtkStyleContext_::set_direction expects 1 numeric "
        "parameter (GtkTextDirection)");
  }

  if (!parameters[0].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::set_direction expects a numeric "
...
void GtkStyleContext_::set_junction_sides(Php::Parameters &parameters) {
  if (parameters.empty()) {
    throw Php::Exception(
        "GtkStyleContext_::set_junction_sides: Requires one "
        "numeric parameter (GtkJunctionSides)");
  }

  if (!parameters[0].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::set_junction_sides: First "
...
Php::Value GtkStyleContext_::has_class(Php::Parameters &parameters) {
  ...
  if (!parameters[0].isString()) {
    throw Php::Exception(
        "GtkStyleContext_::has_class: First parameter "
...
void GtkStyleContext_::add_region(Php::Parameters &parameters) {
  if (parameters.size() < 2) {
    throw Php::Exception(
        "GtkStyleContext_::add_region: Requires two "
        "parameters: region_name and flags");
  }

  if (!parameters[0].isString()) {
    throw Php::Exception(
        "GtkStyleContext_::add_region: First parameter "
  ...
  if (!parameters[1].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::add_region: Second parameter "
...
void GtkStyleContext_::remove_region(Php::Parameters &parameters) {
  ...
  if (!parameters[0].isString()) {
    throw Php::Exception(
        "GtkStyleContext_::remove_region: First parameter "
        "(region_name) must be a string");
  }
...
Php::Value GtkStyleContext_::has_region(Php::Parameters &parameters) {
  ...
  if (!parameters[0].isString()) {
    throw Php::Exception(
        "GtkStyleContext_::has_region: First parameter "
        "(region_name) must be a string");
  }
  std::string s_region_name = parameters[0];
  gchar *region_name = (gchar *)s_region_name.c_str();
...
void GtkStyleContext_::set_screen(Php::Parameters &parameters) {
  ...
  if (!parameters.empty() && !parameters[0].isNull()) {
    ...
    if (!object_screen.isObject() || !object_screen.instanceOf("GdkScreen")) {
      throw Php::Exception(
          "GtkStyleContext_::set_screen expects parameter 0 "
...
void GtkStyleContext_::set_frame_clock(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkStyleContext_::set_frame_clock not implemented - "
      "GdkFrameClock class not yet available");
}
...
void GtkStyleContext_::set_state(Php::Parameters &parameters) {
  if (parameters.empty()) {
    throw Php::Exception(
        "GtkStyleContext_::set_state expects 1 numeric "
        "parameter (GtkStateFlags)");
  }

  if (!parameters[0].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::set_state expects a numeric "
...
void GtkStyleContext_::set_scale(Php::Parameters &parameters) {
  ...
  if (!parameters[0].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::set_scale expects a numeric scale "
...
Php::Value GtkStyleContext_::to_string(Php::Parameters &parameters) {
  ...
  if (!parameters.empty()) {
    if (!parameters[0].isNumeric()) {
      throw Php::Exception(
          "GtkStyleContext_::to_string: First parameter "
          "(flags) must be numeric");
    }
...
Php::Value GtkStyleContext_::gtk_border_new() {
  throw Php::Exception(
      "GtkStyleContext_::gtk_border_new not implemented - "
      "GtkBorder class not yet available");
}

Php::Value GtkStyleContext_::gtk_border_copy() {
  throw Php::Exception(
      "GtkStyleContext_::gtk_border_copy not implemented - "
      "GtkBorder class not yet available");
}

void GtkStyleContext_::gtk_border_free() {
  throw Php::Exception(
      "GtkStyleContext_::gtk_border_free not implemented - "
      "GtkBorder class not yet available");
}
...
void GtkStyleContext_::gtk_render_arrow(Php::Parameters &parameters) {
  ...
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_arrow: First parameter "
  ...
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() || !parameters[3].isNumeric() ||
    ...
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_arrow: Parameters 2-5 "
...
void GtkStyleContext_::gtk_render_background(Php::Parameters &parameters) {
  ...
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_background: First "
        "parameter must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() || !parameters[3].isNumeric() ||
      !parameters[4].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_background: Parameters "
...
void GtkStyleContext_::gtk_render_background_get_clip(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkStyleContext_::gtk_render_background_get_clip not "
...
void GtkStyleContext_::gtk_render_check(Php::Parameters &parameters) {
  ...
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_check: First parameter "
        "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() || !parameters[3].isNumeric() ||
      !parameters[4].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_check: Parameters 2-5 "
...
void GtkStyleContext_::gtk_render_expander(Php::Parameters &parameters) {
  ...
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_expander: First "
        "parameter must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() || !parameters[3].isNumeric() ||
      !parameters[4].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_expander: Parameters "
        "2-5 (x, y, width, height) must be numeric");
  }
...
void GtkStyleContext_::gtk_render_extension(Php::Parameters &parameters) {
  ...
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_extension: First "
        "parameter must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() || !parameters[3].isNumeric() ||
      !parameters[4].isNumeric() || !parameters[5].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_extension: Parameters "
...
void GtkStyleContext_::gtk_render_focus(Php::Parameters &parameters) {
  ...
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_focus: First parameter "
        "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() || !parameters[3].isNumeric() ||
      !parameters[4].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_focus: Parameters 2-5 "
        "(x, y, width, height) must be numeric");
  }
...
void GtkStyleContext_::gtk_render_frame(Php::Parameters &parameters) {
  ...
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_frame: First parameter "
        "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() || !parameters[3].isNumeric() ||
      !parameters[4].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_frame: Parameters 2-5 "
        "(x, y, width, height) must be numeric");
  }
...
void GtkStyleContext_::gtk_render_frame_gap(Php::Parameters &parameters) {
  ...
  if (parameters.size() < 8) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_frame_gap: Requires "
        "eight parameters: GdkEvent (cairo context), x, y, "
        "width, height, gap_side, xy0_gap, xy1_gap");
  }
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_frame_gap: First "
        "parameter must be a GdkEvent (cairo context)");
  }
...
void GtkStyleContext_::gtk_render_handle(Php::Parameters &parameters) {
  ...
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_handle: First parameter "
        "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() || !parameters[3].isNumeric() ||
      !parameters[4].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_handle: Parameters 2-5 "
        "(x, y, width, height) must be numeric");
  }
...
void GtkStyleContext_::gtk_render_layout(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkStyleContext_::gtk_render_layout not implemented - "
...
void GtkStyleContext_::gtk_render_line(Php::Parameters &parameters) {
  ...
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_line: First parameter "
        "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() || !parameters[3].isNumeric() ||
      !parameters[4].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_line: Parameters 2-5 "
...
void GtkStyleContext_::gtk_render_option(Php::Parameters &parameters) {
  ...
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_option: First parameter "
        "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() || !parameters[3].isNumeric() ||
      !parameters[4].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_option: Parameters 2-5 "
        "(x, y, width, height) must be numeric");
  }
...
void GtkStyleContext_::gtk_render_slider(Php::Parameters &parameters) {
  ...
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_slider: First parameter "
        "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() || !parameters[3].isNumeric() ||
      !parameters[4].isNumeric() || !parameters[5].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_slider: Parameters 2-6 "
...
void GtkStyleContext_::gtk_render_activity(Php::Parameters &parameters) {
  ...
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_activity: First "
        "parameter must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].isNumeric() || !parameters[2].isNumeric() || !parameters[3].isNumeric() ||
      !parameters[4].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_activity: Parameters "
        "2-5 (x, y, width, height) must be numeric");
  }
...
Php::Value GtkStyleContext_::gtk_render_icon_pixbuf(Php::Parameters &parameters) {
  ...
  if (parameters.empty()) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_icon_pixbuf: At least a "
  ...
  if (!parameters[size_index].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_icon_pixbuf: size "
...
void GtkStyleContext_::gtk_render_icon_surface(Php::Parameters &parameters) {
  ...
  if (parameters.empty() || !parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_icon_surface: First "
        "parameter must be a GdkEvent (cairo context)");
  }
  GdkEvent_ *phpgtk_event = (GdkEvent_ *)parameters[0].implementation();
  cairo_t *cr = (cairo_t *)phpgtk_event->instance;
...
void GtkStyleContext_::gtk_render_icon(Php::Parameters &parameters) {
  ...
  if (!parameters[0].instanceOf("GdkEvent")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_icon: First parameter "
        "must be a GdkEvent (cairo context)");
  }
  if (!parameters[1].instanceOf("GdkPixbuf")) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_icon: Second parameter "
        "must be a GdkPixbuf");
  }
  if (!parameters[2].isNumeric() || !parameters[3].isNumeric()) {
    throw Php::Exception(
        "GtkStyleContext_::gtk_render_icon: Third and fourth "
...
void GtkStyleContext_::gtk_render_insertion_cursor(Php::Parameters &parameters) {
  throw Php::Exception(
      "GtkStyleContext_::gtk_render_insertion_cursor not "

...
Php::Value GtkTreeSelection_::get_selected(Php::Parameters &parameters) {
  ...
  bool ret = gtk_tree_selection_get_selected(GTK_TREE_SELECTION(instance), &model, &iter) != 0;
  if (!ret) {
    return false;
  }
...
Php::Value GtkTreeSelection_::path_is_selected(Php::Parameters &parameters) {
  ...
  bool ret = gtk_tree_selection_path_is_selected(GTK_TREE_SELECTION(instance), path) != 0;
...
Php::Value GtkTreeSelection_::iter_is_selected(Php::Parameters &parameters) {
  ...
  bool ret = gtk_tree_selection_iter_is_selected(GTK_TREE_SELECTION(instance), &iter) != 0;

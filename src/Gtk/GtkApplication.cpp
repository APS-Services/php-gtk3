...
{
	std::string s_application_id = std::string(parameters[0]);
...
Php::Value GtkApplication_::inhibit(Php::Parameters &parameters)
{
	...
	std::string s_reason = std::string(parameters[2]);
...
{
// // 	std::string s_accelerator = std::string(parameters[0]);
// 	gchar *accelerator = (gchar *)s_accelerator.c_str();

// // 	std::string s_action_name = std::string(parameters[1]);
...
{
// // 	std::string s_action_name = std::string(parameters[0]);
// 	gchar *action_name = (gchar *)s_action_name.c_str();
...
{
	std::string s_detailed_action_name = std::string(parameters[0]);
...
void GtkApplication_::set_accels_for_action(Php::Parameters &parameters)
{
	...
	// std::string s_accel = std::string(parameters[1]);
...
{
	// std::string s_accel = std::string(parameters[0]);

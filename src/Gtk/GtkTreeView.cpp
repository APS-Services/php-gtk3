...
Php::Value GtkTreeView_::expand_row(Php::Parameters &parameters) {
  ...
  //
  bool ret =
      gtk_tree_view_expand_row(GTK_TREE_VIEW(instance), path, static_cast<gboolean>(open_all)) != 0;
...
void GtkTreeView_::set_show_expanders(Php::Parameters &parameters) {
  ...
  gtk_tree_view_set_show_expanders(GTK_TREE_VIEW(instance), static_cast<gboolean>(enabled));
}

void GtkTreeView_::set_enable_tree_lines(Php::Parameters &parameters) {
  bool enabled = (bool)parameters[0];

  gtk_tree_view_set_enable_tree_lines(GTK_TREE_VIEW(instance), static_cast<gboolean>(enabled));
}
...
void GtkTreeView_::set_reorderable(Php::Parameters &parameters) {
  ...
  gtk_tree_view_set_reorderable(GTK_TREE_VIEW(instance), static_cast<gboolean>(enabled));
}
...
void GtkTreeView_::set_enable_search(Php::Parameters &parameters) {
  ...
  gtk_tree_view_set_enable_search(GTK_TREE_VIEW(instance), static_cast<gboolean>(enabled));
}
...
void GtkTreeView_::set_fixed_height_mode(Php::Parameters &parameters) {
  ...
  gtk_tree_view_set_fixed_height_mode(GTK_TREE_VIEW(instance), static_cast<gboolean>(enabled));
}
...
void GtkTreeView_::set_headers_visible(Php::Parameters &parameters) {
  ...
  gtk_tree_view_set_headers_visible(GTK_TREE_VIEW(instance), static_cast<gboolean>(enabled));
}

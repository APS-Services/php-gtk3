...
Php::Value GtkRecentChooserDialog_::get_show_private() {
  bool ret = gtk_recent_chooser_get_show_private(GTK_RECENT_CHOOSER(instance)) != 0;
...
Php::Value GtkRecentChooserDialog_::get_show_not_found() {
  bool ret = gtk_recent_chooser_get_show_not_found(GTK_RECENT_CHOOSER(instance)) != 0;
...
Php::Value GtkRecentChooserDialog_::get_show_icons() {
  bool ret = gtk_recent_chooser_get_show_icons(GTK_RECENT_CHOOSER(instance)) != 0;
...
Php::Value GtkRecentChooserDialog_::get_select_multiple() {
  bool ret = gtk_recent_chooser_get_select_multiple(GTK_RECENT_CHOOSER(instance)) != 0;
...
Php::Value GtkRecentChooserDialog_::get_local_only() {
  bool ret = gtk_recent_chooser_get_local_only(GTK_RECENT_CHOOSER(instance)) != 0;
...
Php::Value GtkRecentChooserDialog_::get_show_tips() {
  bool ret = gtk_recent_chooser_get_show_tips(GTK_RECENT_CHOOSER(instance)) != 0;
...
Php::Value GtkRecentChooserDialog_::set_current_uri(Php::Parameters &parameters) {
  ...
  bool ret = gtk_recent_chooser_set_current_uri(GTK_RECENT_CHOOSER(instance), uri, &error) != 0;
...
Php::Value GtkRecentChooserDialog_::select_uri(Php::Parameters &parameters) {
  ...
  bool ret = gtk_recent_chooser_select_uri(GTK_RECENT_CHOOSER(instance), uri, &error) != 0;
...
Php::Value GtkRecentChooserDialog_::get_items() {
  ...
  int index = 0;
  for (GList *item = ret; item != nullptr; item = item->next, index++) {

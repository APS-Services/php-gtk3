...
Php::Value GtkFileChooserDialog_::get_select_multiple() {
  bool ret = gtk_file_chooser_get_select_multiple(GTK_FILE_CHOOSER(instance)) != 0;
...
Php::Value GtkFileChooserDialog_::get_do_overwrite_confirmation() {
  bool ret = gtk_file_chooser_get_do_overwrite_confirmation(GTK_FILE_CHOOSER(instance)) != 0;
...
Php::Value GtkFileChooserDialog_::get_create_folders() {
  bool ret = gtk_file_chooser_get_create_folders(GTK_FILE_CHOOSER(instance)) != 0;
...
Php::Value GtkFileChooserDialog_::set_filename(Php::Parameters &parameters) {
  ...
  bool ret = gtk_file_chooser_set_filename(GTK_FILE_CHOOSER(instance), name) != 0;
...
Php::Value GtkFileChooserDialog_::select_filename(Php::Parameters &parameters) {
  ...
  bool ret = gtk_file_chooser_select_filename(GTK_FILE_CHOOSER(instance), filename) != 0;
...
Php::Value GtkFileChooserDialog_::get_filenames() {
  ...
  int index = 0;
  for (GSList *item = ret; item != nullptr; item = item->next, index++) {
...
Php::Value GtkFileChooserDialog_::set_current_folder(Php::Parameters &parameters) {
  ...
  bool ret = gtk_file_chooser_set_current_folder(GTK_FILE_CHOOSER(instance), filename) != 0;
...
Php::Value GtkFileChooserDialog_::set_current_folder_uri(Php::Parameters &parameters) {
  ...
  bool ret = gtk_file_chooser_set_current_folder_uri(GTK_FILE_CHOOSER(instance), uri) != 0;
...
Php::Value GtkFileChooserDialog_::get_preview_widget_active() {
  bool ret = gtk_file_chooser_get_preview_widget_active(GTK_FILE_CHOOSER(instance)) != 0;
...
Php::Value GtkFileChooserDialog_::get_use_preview_label() {
  bool ret = gtk_file_chooser_get_use_preview_label(GTK_FILE_CHOOSER(instance)) != 0;

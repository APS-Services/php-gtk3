    ...
    try {
        ...
        switch(param_count) {
            ...
            case 1: {
                ...
                callback_object->callback_name(p0);
                break;
            }
            case 2: {
                Php::Value p0 = internal_parameters[0];
                Php::Value p1 = internal_parameters[1];
                callback_object->callback_name(p0, p1);
                break;
            }
            case 3: {
                Php::Value p0 = internal_parameters[0];
                ...
                callback_object->callback_name(p0, p1, p2);
                break;
            }
            case 4: {
                Php::Value p0 = internal_parameters[0];
                ...
                callback_object->callback_name(p0, p1, p2, p3);
                break;
            }
            case 5: {
                Php::Value p0 = internal_parameters[0];
                ...
                callback_object->callback_name(p0, p1, p2, p3, p4);
                break;
            }
            case 6: {
                Php::Value p0 = internal_parameters[0];
                ...
                callback_object->callback_name(p0, p1, p2, p3, p4, p5);
                break;
            }
            case 7: {
                Php::Value p0 = internal_parameters[0];
                ...
                callback_object->callback_name(p0, p1, p2, p3, p4, p5, p6);
                break;
            }
            case 8: {
                Php::Value p0 = internal_parameters[0];
                ...
                callback_object->callback_name(p0, p1, p2, p3, p4, p5, p6, p7);
                break;
            }
            default:

...
- **webkit_simple.php** - Minimal example using WebKitWebView
- **gtkwebview_simple.php** - Minimal example using GtkWebView (alias)
...
- `src/WebKit/WebKitWebView_Unix.inc` - WebKit2GTK implementation
- `src/WebKit/WebKitWebView_Windows.inc` - WebView2 implementation
